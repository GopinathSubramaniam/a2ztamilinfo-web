...
define('WP_SITEURL', Util::getProperty('protocol').'://' . $_SERVER['HTTP_HOST'] . Util::getProperty('app_base'));
define('WP_HOME', Util::getProperty('protocol').'://' . $_SERVER['HTTP_HOST'] . Util::getProperty('app_base'));
